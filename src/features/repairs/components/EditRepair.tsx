...
export default function EditRepair({ repair }: { repair: Repair }) {
  const { form, onSubmit, open, setOpen, isLoading } = useEditRepair(repair);
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="max-w-3xl max-h-[100vh] p-0">
          <DialogHeader className="px-6 pt-6">
            <DialogTitle className="text-2xl">Edit Repair</DialogTitle>
            <DialogDescription>
              Fill in the repair information below. All required fields are
